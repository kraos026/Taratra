...
import { rebuildAutomationSpecification } from "@/modules/automation-specifications/presentation/automation-specification-api";
...
export async function POST(request: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  const result = await rebuildAutomationSpecification(id.data, body.data.lockVersion);
